...
export namespace events {
    ...
    export class ServiceClient {
        ...
        public async BuyTickets(id: string, params: BuyTicketRequest): Promise<BaseResponse<BuyTicketResponse>> {
            ...
            const resp = await this.baseClient.callAPI("POST", `/v1/events/${encodeURIComponent(id)}/tickets/buy`, JSON.stringify(params))
        ...
        public async CreateEvent(params: CreateEventRequest): Promise<BaseResponse<InsertionResponse>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callAPI("POST", `/v1/events`, JSON.stringify(params))
        ...
        public async CreateTickets(id: string, params: CreateTicketRequest): Promise<BaseResponse<InsertionResponse>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callAPI("POST", `/v1/events/${encodeURIComponent(id)}/tickets/create`, JSON.stringify(params))
            return await resp.json() as BaseResponse<InsertionResponse>
        }
        ...
        public async DeleteTickets(id: string, params: DeleteTicketRequest): Promise<BaseResponse<DeletesResponse>> {
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callAPI("DELETE", `/v1/events/${encodeURIComponent(id)}/tickets/delete`, undefined, {query})
        ...
        public async GetEvent(id: string): Promise<BaseResponse<Event>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callAPI("GET", `/v1/events/${encodeURIComponent(id)}`)
        ...
        public async ListEventAttendees(id: string, params: ListQuery): Promise<BaseResponse<db.ListAttendeeRow[]>> {
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callAPI("GET", `/v1/events/${encodeURIComponent(id)}/attendees`, undefined, {query})
        ...
        public async ListEvents(params: ListQuery): Promise<BaseResponse<Event[]>> {
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callAPI("GET", `/v1/events`, undefined, {query})
            return await resp.json() as BaseResponse<Event[]>
        }
        ...
        public async UpdateTickets(id: string, params: UpdateTicketRequest): Promise<BaseResponse<UpdatesResponse>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callAPI("PUT", `/v1/events/${encodeURIComponent(id)}/tickets/update`, JSON.stringify(params))
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "ggrims-services-n2gi-Generated-TS-Client (Encore/v1.43.8)";
        }
