...
export function Environment(name: string): BaseURL {
  ...
  return `https://${name}-ggrims-backend-69ki.encr.app`
}
...
/**
 * Client is an API client for the ggrims-backend-69ki Encore application.
 */
...
export namespace events {
  ...
  /**
   * Ticket represents a ticket type in the event.
   */
  ...
  /**
   * TicketInput represents the additional inputs for each ticket.
   */
  ...
  export class ServiceClient {
    ...
    public async CreateEvent(params: CreateEventRequest): Promise<BaseResponse<InsertionResponse>> {
      ...
      const resp = await this.baseClient.callAPI("POST", `/v2/events`, JSON.stringify(params))
...
class BaseClient {
  ...
  constructor(baseURL: string, options: ClientOptions) {
    ...
    if (typeof window === "undefined") {
      this.headers["User-Agent"] = "ggrims-backend-69ki-Generated-TS-Client (Encore/v1.43.8)"
    }
